...
public static ArrayList<Jogador> ler(){
    ...
    public static void selecao (int[] array, ArrayList<Jogador> lista, int tam){
        for(int i = 0; i < 10; i++){
            int menor = i;
            for(int j = i + 1; j < 10; j++ ){
                if(ordenacao(array[menor], array[j], lista) == true){
                    menor = j;
                }
            }
            swap(array,menor,i);
    ...
    public static void selecaoParci(int[] array, ArrayList<Jogador> lista, int tam){
        selecao(array,lista,tam);
        for(int i = 0; i < tam; i++){
            if(ordenacao(array[9],array[i],lista) == true){
                    swap(array,9,i);
                    selecao(array,lista,tam);
            }
        }
