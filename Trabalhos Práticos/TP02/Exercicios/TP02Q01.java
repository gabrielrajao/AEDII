...
public class TP02Q01{
    ...
    public TP02Q01(int id, String nome, int altura, int peso, String uni, int Nasc, String cidade, String estado){
        this.id = id;
        this.nome = nome;
        this.altura = altura;
        this.peso = peso;
    ...
    public TP02Q01 clone(){
        return new TP02Q01(this.id,this.nome,this.altura,this.peso,this.uni,this.Nasc,this.cidade,this.estado);
    }



    public static ArrayList<TP02Q01> ler(){
        Arq.openRead("/tmp/players.csv");
        ArrayList<TP02Q01> listares = new ArrayList<TP02Q01>();
        while(Arq.hasNext()==true){
            ...
            listares.add(new TP02Q01(id,nome,altura, peso, uni, Nasc, cidade, estado));
        }
        Arq.close();
        return listares;
    }
